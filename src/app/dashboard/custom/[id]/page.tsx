...
const QuizPage = () => {
        ...
        try {
          const body = {
            ...
            description:
              ...
              `Generate 7 quiz questions for the category "${id}".`,
            inputValue:
  ...
  }, [id, descriptionFromQuery, questions.length]);
  ...
  useEffect(() => {
    if (quizCompleted) {
      ...
      const storageKey = `ai-quizScores-${user?.user?.email}`;
  ...
  }, [quizCompleted, id, score, attempted, user]);
      ...
      <div className="flex items-center justify-center min-h-[80vh] flex-col p-6">
        <Card className="p-8 bg-gradient-to-br from-purple-900/80 to-indigo-900/80 backdrop-blur-lg border-purple-500 shadow-xl w-full max-w-md">
          <div className="flex flex-col items-center justify-center">
            ...
            >
              {loadingProgress < 30 ? "Thinking of challenging questions..." : 
               loadingProgress < 60 ? "Crafting interesting options..." : 
               loadingProgress < 90 ? "Adding fascinating facts..." : 
               "Almost ready!"}
            </motion.p>
          </div>
        </Card>
        ...
        >
          <Card className="p-8 bg-gradient-to-br from-purple-900/80 to-indigo-900/80 backdrop-blur-lg border-purple-500 shadow-xl text-center">
            ...
            <motion.div
              ...
              className="mb-6"
            >
              <p className="text-2xl text-purple-100 mb-2">Your Score: <span className="font-bold text-yellow-400">{score}</span></p>
            ...
            >
              ...
              <Button 
                onClick={() => router.push(`/quiz/custom/${id}`)}
                variant="outline"
                className="border-purple-500 text-purple-100 hover:bg-purple-800/30"
              >
          ...
          <div className="space-y-3">
            <AnimatePresence>
              {questions[currentQuestion]?.options.map((option: string, index: number) => {
                ...
                let optionClasses = "p-4 rounded-lg border border-purple-500/50 cursor-pointer transition-all hover:bg-purple-700/50 text-white";
                ...
                return (
                  <motion.div
                    ...
                    animate={{ 
                      ...
                      boxShadow: isSelected && isCorrect ? "0 0 15px rgba(34, 197, 94, 0.5)" : 
                                isSelected && !isCorrect ? "0 0 15px rgba(239, 68, 68, 0.5)" : "none"
                    }}
                    transition={{ 
                      duration: 0.3, 
                      delay: index * 0.1,
                    ...
                    whileHover={selectedAnswer === null && gameState === "playing" ? { 
                      scale: 1.02,
